...
const Navbar = () => {
    ...
    return (
      ...
      <a href='/product-type/tiles'><button>Tiles</button></a>
      <a href='/product-type/benches'><button>Benches</button></a>
      <a href='/product-type/windows'><button>Windows</button></a>
      <a href='/product-type/lab-tables'><button>Lab-Tables</button></a>
  </div>
        </div>
    )
}
